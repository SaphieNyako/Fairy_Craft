package com.saphienyako.fairy_craft.screen;
...
public class FairyAltarMenu extends AbstractContainerMenu {
    public final FairyAltarBlockEntity blockEntity;
    private final Level level;
    private final ContainerData data;

    public FairyAltarMenu(int pContainerId, Inventory inv, FriendlyByteBuf extraData) {
        this(pContainerId, inv, inv.player.level().getBlockEntity(extraData.readBlockPos()), new SimpleContainerData(5));
    }

    public FairyAltarMenu(int pContainerId, Inventory inv, BlockEntity entity, ContainerData data) {
        super(ModMenuTypes.FAIRY_ALTAR_MENU.get(), pContainerId);
        checkContainerSize(inv, 5);
        blockEntity = ((FairyAltarBlockEntity) entity);
    ...
    public boolean stillValid(@NotNull Player player) {
        return stillValid(ContainerLevelAccess.create(level, blockEntity.getBlockPos()),
                player, ModBlocks.FAIRY_ALTAR.get());
    }

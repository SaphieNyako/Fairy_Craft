...
import com.saphienyako.fairy_craft.entity.animations.AutumnPixieAnimations;
...
public class AutumnPixieModel<T extends Entity> extends HierarchicalModel<T> {
    ...
    public void setupAnim(Entity entity, float limbSwing, float limbSwingAmount, float ageInTicks, float netHeadYaw, float headPitch) {
        ...
        this.animate(((AutumnPixieEntity)entity).SPELL_CASTING_ANIMATION, AutumnPixieAnimations.IDLE, ageInTicks, 2f);
    }
